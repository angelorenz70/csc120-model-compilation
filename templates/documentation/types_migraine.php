...
<html lang="en">
    ...
    <body id="page-top">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                   <li><a class="dropdown-item" href="/energy_efficiency/doc">Energy Efficiency (LinR) Doc</a></li>
                                    ...
                                    <li><a class="dropdown-item" href="/reinforcementLearning/doc">Frozen Lake (RL) Doc</a></li>li>
                            </ul>
                        </li>
                    </ul>
                </div>
                ...
                <ul class="timeline">
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class=" ">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p></div>
                        </div>
                    </li>
        ...
        style="background: rgb(63,94,251); background: radial-gradient(circle, rgba(63,94,251,1) 0%, rgba(187,70,252,1) 100%);">
            <div class="container">
                <div class="text-center">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                        ...
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                ...
                                <div class="portfolio-caption-subheading  ">Branding</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
                        ...
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                ...
                                <div class="portfolio-caption-subheading  ">Website Design</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                ...
                                <div class="portfolio-caption-subheading  ">Photography</div>
                            </div>
                        </div>
                    </div>
                </div>
