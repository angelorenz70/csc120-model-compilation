    ...
    <body id="page-top">
        <div class="container" id="main1">
            ...
            <header class="masthead">
                <div class="gallery">
                    <div id="energy_e" style="background-image: url('assets/img/bg-energy-efficiency.jpg');" class="center"><p><a href="forms/energy_efficiency/energy_e.php">ENERGY EFFICIENCY</a></p></div>
                    <div id="heart_d" style="background-image: url('assets/img/bg-heart-disease.jpg');" class="center"><p><a href="forms/heart_disease/heart_d.php">HEART DISEASE</a></p></div>
                    <div id="t_migraine" style="background-image: url('assets/img/bg-migraine1.jpg');" class="center"><p><a href="forms/types_migraine/migraine_t.php">TYPES OF MIGRAINE</a></p></div>
                </div>
            </header>
        </div>
        <!-- Team-->
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="assets/member/angel.jpg" alt="..." />
                    ...
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="assets/member/angelo.jpg" alt="..." />
                    ...
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="assets/member/breech.jpg" alt="..." />
